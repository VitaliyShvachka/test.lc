 ...
 */
     ...
     * @method static \Illuminate\Http\Client\PendingRequest withBody(resource|string $contents, string $contentType)
     ...
     */
         ...
         *
         * This method can read the client IP address from the "X-Forwarded-For" headers
         * when trusted proxies were set via "setTrustedProxies()". The "X-Forwarded-For"
         * headers value is a comma+space separated list of IP addresses, the left-most
         * being the original client, and each successive proxy that passed the request
         * adding the IP address where it received the request from.
         *
         * If your reverse proxy uses a different headers name than "X-Forwarded-For",
         ...
         *
         * This method can read the client port from the "X-Forwarded-Port" headers
         * when trusted proxies were set via "setTrustedProxies()".
         *
         * The "X-Forwarded-Port" headers must contain the client port.
         *
         ...
         *
         * This method can read the client protocol from the "X-Forwarded-Proto" headers
         * when trusted proxies were set via "setTrustedProxies()".
         *
         * The "X-Forwarded-Proto" headers must contain the protocol: "https" or "http".
         *
         * @return bool
         * @static
         */
         ...
         *
         * This method can read the client host name from the "X-Forwarded-Host" headers
         * when trusted proxies were set via "setTrustedProxies()".
         *
         * The "X-Forwarded-Host" headers must contain the client host name.
         *
         * @return string
         ...
         *
         * If the X-HTTP-Method-Override headers is set, and if the method is a POST,
         ...
         *
         * @param string|array $mimeTypes The associated mime types (the preferred one must be the first as it will be used as the contents type)
         * @static
         */
         ...
         * server might be different. This returns the former (from the "Via" headers)
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Returns the request body contents.
         *
         ...
         *   * the values of the Accept HTTP headers.
         *
         * Note that if you use this method, you should send the "Vary: Accept" headers
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets a list of contents types acceptable by the client browser in preferable order.
         *
         * @return array
         * @static
         */
         ...
         *
         * It works if your JavaScript library sets an X-Requested-With HTTP headers.
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Checks whether the client browser prefers safe contents or not according to RFC8674.
         *
         ...
         * contents of a proxy-specific headers.
         *
         * @return bool
         * @static
         */
        ...
        public static function wantsJson()
        {
                    ...
                    /**
         * Determines whether the current requests accepts a given contents type.
         *
        ...
        public static function accepts($contentTypes)
        {
                    ...
                    /**
         * Return the most suitable contents type from the given array based on contents negotiation.
         *
         * @param string|array $contentTypes
         * @return string|null
         * @static
        ...
        public static function prefers($contentTypes)
        {
                    ...
                    /**
         * Determine if the current request accepts any contents type.
         *
         * @return bool
         * @static
         */
        ...
        public static function acceptsHtml()
        {
                    ...
                    /**
         * Determine if the given contents types match.
         *
         * @param string $actual
         * @param string $type
         * @return bool
        ...
        public static function hasHeader($key)
        {
                    ...
                    /**
         * Retrieve a headers from the request.
         *
         * @param string|null $key
         * @param string|array|null $default
         * @return string|array|null
     ...
     */
        ...
        public static function make($content = '', $status = 200, $headers = [])
        {
                    ...
                    /**
         * Create a new "no contents" response.
         *
         * @param int $status
         * @param array $headers
         * @return \Illuminate\Http\Response
...
')
     ...
     */
        ...
        public static function first($views, $data = [], $mergeData = [])
        {
                    ...
                    /**
         * Get the rendered contents of the view based on a given condition.
         *
        ...
        public static function renderWhen($condition, $view, $data = [], $mergeData = [])
        {
                    ...
                    /**
         * Get the rendered contents of the view based on the negation of a given condition.
         *
         * @param bool $condition
         * @param string $view
         * @param \Illuminate\Contracts\Support\Arrayable|array $data
        ...
        public static function slot($name, $content = null, $attributes = [])
        {
                    ...
                    /**
         * Save the slot contents for rendering.
         *
         * @return void
         * @static
         */
        ...
        public static function callCreator($view)
        {
                    ...
                    /**
         * Start injecting contents into a section.
         *
        ...
        public static function startSection($section, $content = null)
        {
                    ...
                    /**
         * Inject inline contents into a section.
         *
         * @param string $section
         * @param string $content
         * @return void
        ...
        public static function inject($section, $content)
        {
                    ...
                    /**
         * Stop injecting contents into a section and return its contents.
         *
         * @return string
         * @static
         */
        public static function yieldSection()
        {
                    ...
                    /**
         * Stop injecting contents into a section.
         *
         * @param bool $overwrite
         * @return string
         * @throws \InvalidArgumentException
        ...
        public static function stopSection($overwrite = false)
        {
                    ...
                    /**
         * Stop injecting contents into a section and append it.
         *
         * @return string
         * @throws \InvalidArgumentException
         * @static
        ...
        public static function getLoopStack()
        {
                    ...
                    /**
         * Start injecting contents into a push section.
         *
         * @param string $section
         * @param string $content
         * @return void
        ...
        public static function startPush($section, $content = '')
        {
                    ...
                    /**
         * Stop injecting contents into a push section.
         *
         * @return string
         * @throws \InvalidArgumentException
         * @static
        ...
        public static function stopPush()
        {
                    ...
                    /**
         * Start prepending contents into a push section.
         *
         * @param string $section
         * @param string $content
         * @return void
        ...
        public static function startPrepend($section, $content = '')
        {
                    ...
                    /**
         * Stop prepending contents into a push section.
         *
         * @return string
         * @throws \InvalidArgumentException
         * @static
